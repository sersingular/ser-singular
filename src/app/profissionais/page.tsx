...
const profissionais = [
  {
    ...
    desc: "Com 13 anos de experiência em desenvolvimento infantil, Daiana fundou a Ser Singular com a missão de transformar vidas através de um atendimento singular, acolhedor e baseado em evidências. Especializada em avaliação diagnóstica de TEA e TDAH, utiliza metodologias como ABA e Modelo Denver, amplamente reconhecidas no suporte a crianças no espectro autista.",
    especialidades: ["Especialista em TEA e TDAH", "Avaliação Diagnóstica de Autismo", "ABA", "Denver", "Avaliação Neuropsicológica", "Orientação de Pais"],
  ...
  },
  {
    ...
    desc: "Especializada em comunicação social no espectro autista, Thainá atua com crianças com TEA utilizando PROMPT e DTTC, abordagens baseadas em evidências para o desenvolvimento da fala e linguagem. Atende também crianças com dificuldades de comunicação e outros perfis de neurodesenvolvimento.",
